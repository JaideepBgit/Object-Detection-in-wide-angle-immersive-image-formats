...
class VGGBase(nn.Module):
    ...
    def load_pretrained_layers(self):
        ...
        conv_fc7_weight_1 = decimate(conv_fc7_weight, m=[4, 4, None, None])  # (1024, 1024, 1, 1)
        conv_fc7_weight_1 = torch.cat((conv_fc7_weight_1,conv_fc7_weight_1,conv_fc7_weight_1),2)
        state_dict['conv7.weight'] = torch.cat((conv_fc7_weight_1,conv_fc7_weight_1,conv_fc7_weight_1),3)
        ...
        for i in range(batch_size):
            ...
            for c in range(1, self.n_classes):
                ...
                for box in range(class_decoded_locs.size(0)):
                    ...
                    suppress = torch.max(suppress, (overlap[box] > max_overlap).byte())   #.byte()
