...
batch_size = 4  # set accodring to laptop capacity, preferably 5 or less
start_epoch = 0  # start at this epoch
epochs = 45  # number of epochs to run without early-stopping
...
def main():
    ...
    if checkpoint is None:
        ...
        optimizer = torch.optim.RMSprop(params=[{'params': biases, 'lr': 2 * lr}, {'params': not_biases}],
                                    lr=lr, momentum=momentum, weight_decay=weight_decay) # rmsprop optimizer used according to spherenet paper
